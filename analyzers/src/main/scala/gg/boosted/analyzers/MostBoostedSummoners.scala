...
object MostBoostedSummoners {
    ...
    /**
      ...
      */
    def calculate(ds: Dataset[SummonerMatch], minGamesPlayed:Int, since:Long, maxRank:Int):Dataset[MostBoostedSummoners] = {
        ...
        ds.sparkSession.sql(
            s"""SELECT championId, roleId, summonerId, region, gamesPlayed, winrate, matches,
               ...
               |) having rank <= $maxRank
      """.stripMargin).as[MostBoostedSummoners]
    }
